...
Note
---------------------
Always use absolute paths to configure and compile BGL Core and the dependencies.
...
To build BGL Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Notes
-----
The release is built with GCC and then "strip BGLd" to strip the debug
...
Security
--------
To help make your BGL Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, BGL Core should be built with a non-executable stack,
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, BGL Core may be compiled in
